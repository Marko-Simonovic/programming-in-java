...
public class HelloObjectInit {
    ...
    // Anonymous block (1) = 3rd called, after static
    {
    ...
    // Anonymous static block (1) = 1st called
    static {
    ...
    // Anonymous block (2) = 4th called, after static
    {
    ...
    // Anonymous static block (2) = 2nd called
    static {
        S_CONST2 = 1.2;
