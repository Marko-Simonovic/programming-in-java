 ...
 * <p>
 *     <b>Question 3 :</b><br>
 *     The Class Object is the root of the class hierarchu, every class has Object as a superclass.<br>
 *     All objects implements (=specialise) the methods of this class. Therefore Object class
 *     can come handy if we want to refer to any object which we don't know the type since
 *     they're all part of Object Class. Many of the common methods come from the Object
 *     Class and are redefined in the child classes if necessary.
 * </p>
