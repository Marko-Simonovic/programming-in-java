...
public class Main {
    ...
    private static final int TEST_LIST_SIZE = 50_000; // can write with underscore for readability
    private static final List<Integer> LongList = new ArrayList<>();

    /**
     * Setting a big long List for testing purposes.
     */
    private static void setLongList(List<Integer> longList) {
    ...
    /**
     * Auxiliary method 1: some operations on a list<br>
     * --> Creation of list<br>
     * --> Adding 2 elements<br>
     * --> Removing 1 element<br>
     * --> Print again
     */
    ...
    /**
     * Auxiliary method 2: time duration of <b>adding elements at the END of a list</b>
     */
    ...
    /**
     * Auxiliary method 3: time duration of <b>adding elements at the FRONT of a list</b>
     */
    private static long dtOfAddingAtTheFront(List<Integer> lst) {
        long t0 = System.currentTimeMillis();
        for (int i = 0; i < TEST_LIST_SIZE; i++) {
            lst.add(0, i); // by specifying index 0, we make sure it's always the front of the list
        }
        return System.currentTimeMillis() - t0;
    }
     ...
     * <br>
     * <b>
     *     WE NEVER DO DOWNCASTING, WE NEVER SAY A LIST IS AN ARRAYLIST.<br>
     *     A LIST IS AN INTERFACE, IT CANT BE A TYPE, IT'S NOT CONCRETE.<br>
     *     A LIST CAN BE AN ARRAYLIST OR A LINKEDLIST.<br>
     *     THE ELEMENT MORE SPECIFIED IN ARRAY LIST WILL JUST BE LOST WHEN
     *     WE PUT THEM INTO A LIST.
     * </b>
     */
    ...
    private static void demoFor(List<Integer> lList) {
    ...
    private static void demoForEach(List<Integer> lList) {
    ...
    /**
     * The function remove the element at index 2 so the value '3'. It prints [1,2,4,5] after removing.
     */
    private static void ListRemoveOutput() {
        ...
        // Here we have a Collection which is the more generic Interface of List
        // Therefore based on the diagram, Collection can be a List, a Set or a Queue.
        // So when we call 'l1.remove(i)' it will adapt to the type given, it can remove an element of an ArrayList
        // just like it can remove an element from a set
        Collection<Integer> l3 = new ArrayList<>(List.of(0, 1, 2));
        for (int i = 0; i < 3; i++) {
            System.out.println(l3.remove(i));
        }
        System.out.println(l3);

        List<Integer> l4 = new ArrayList<>(List.of(0, 1, 2));
        for (int i = 0; i < 3; i++) {
    ...
    public static void main(String[] args) {
        ...
        // DemoFor takes 2 seconds to go through the list
        // DemoForEach takes 3 seconds
        // There is a 1 seconds difference because for each in directly go to the element
        // It doesn't use the call of 'get' to access the value and then affect it, it takes too much time.
        setLongList(LongList);
        demoFor(LongList);
        demoForEach(LongList);
        ListRemoveOutput();
    }
}
