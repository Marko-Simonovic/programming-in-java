...
public class Main {
    ...
    private static void demo1() {
        ...
        IntStream.of(ints).average().ifPresent(avg -> System.out.println("The average of ints: " + avg)); //if present check if optional != empty
        ...
        IntStream.of(ints)
                ...
                .peek(System.out::println) // prints out Double
                .mapToInt(e -> (int) e)
                .forEach(System.out::println); // prints out Int
    }
