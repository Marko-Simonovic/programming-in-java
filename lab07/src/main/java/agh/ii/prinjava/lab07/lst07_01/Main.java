...
public class Main {
    ...
    private static void demo5() {
        ...
        // We give to fonAlphaStream a Stream and after that we can apply the different functions to it
        Stream<Map.Entry<Character, String>> fonAlphaStream = fonAlpha.entrySet().stream();
        fonAlphaStream.forEach(entry -> System.out.println(entry.getKey() + " => " + entry.getValue())); // entry of type Map
    }
