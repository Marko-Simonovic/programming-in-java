...
public class Main {
    ...
    private static void demo1() {
        ...
        iStr.skip(4).forEach(System.out::println); // Skip the first 4 value. out=> 5,6,7,...
    }
    ...
    private static void demo2() {
        ...
        iStr.forEach(System.out::println); // each value will go through the three filter and be printed if they pass
    }
    ...
    private static void demo3() {
        ...
        LIST2.stream()
                .takeWhile(n -> n < 100) // take while value are under 100
                .forEach(System.out::println);

        System.out.println("\nLIST2: " + LIST2 + ", dropWhile(n -> n < 100)");
        LIST2.stream()
                .dropWhile(n -> n < 100) // don't take value until they go once over 100 then do it
                .forEach(System.out::println);
    }
