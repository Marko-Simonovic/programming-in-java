...
/**
 * <b>A functional interface has exactly one abstract method.</b> Since default methods have an implementation,
...
@FunctionalInterface
interface Flyable {
    // !!!! REMEMBER THAT AN ABSTRACT METHOD IN A INTERFACE DOES NOT NEED TO SPECIFY "PUBLIC ABSTRACT"
...
public class Main {
     ...
     *
     * <p><b>!!!!! A method reference (the :: ) directs the compiler to produce an instance of a functional interface,
     * overriding the single abstract method of the interface to call the given method. !!!!!</b>
     *
     ...
     *
     *     <li><b>{@code Class::instanceMethod} - the first parameter becomes the implicit parameter of the method.
     *     For instance, {@code String::compareToIgnoreCase} is the same as {@code (x, y) -> x.compareToIgnoreCase(y)}</b></li>
     *
     *     <li><b>{@code Class::staticMethod} - all parameters are passed to the static method:
     *     {@code Math::pow} is equivalent to {@code (x, y) -> Math.pow(x, y)}</b></li>
     *
     * </ol>
    ...
    private static void demo4() {
        ...
        IFactory<C1> c1Factory = C1::new; // a constructor reference (syntax: className::new) ==> C1 = new C1(x, y)
        C1 c11 = new C1(10, 20);
