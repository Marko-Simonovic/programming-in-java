...
public class Main {
     ...
     * <br>
     * <b>HERE IT SAYS RETURN EITHER <i>"LIST.GET(0)"</i> OR <i>"NULL"</i> DEPENDING ON CONDITION IN THE BRACKETS</b>
     * Read as : "if list different than null... IF YES then get(firstValue), IF NO then return NULL
     */
    ...
    private static void demo3() {
        ...
        //UNKNOWN_HEAD is the param (Other) if no value is present
