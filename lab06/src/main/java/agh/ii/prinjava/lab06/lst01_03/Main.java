...
/**
 * <b>A <i>higher-order function</i> is a function that returns and/or takes other functions as argument(s)</b>
 */
public class Main {
    ...
    private static IntBinaryOperator intBinaryOperatorFactory(BinaryOp binOp) {
        return switch (binOp) {
            // Yes, we can return a lambda expression, it will be a lambda expression of the fInterface IntBinaryOperator
            case ADD -> (a, b) -> a + b;
            case SUB -> (a, b) -> a - b;
            case MUL -> (a, b) -> a * b;
        };
    ...
    private static void demo2() {
        ...
        List<Integer> l1 = LIST_1TO5;
        // Expanded version
        int sum1 = sumOfWith(l1, new UnaryOperator<Integer>() {
            @Override
            public Integer apply(Integer e) {
                return 15;
            }
        });
        int sum2 = sumOfWith(l1, e -> 15 * 15);
        int sum3 = sumOfWith(l1, e -> Math.abs(15));
        System.out.println("sum1: " + sum1 + ", sum2 = " + sum2 + ", sum3 = " + sum3);
    }
    ...
    private static void demo3() {
        ...
        System.out.println("List_1T05 : " + LIST_1TO5 + "\n" + "sum1: " + sum1 + ", sum2 = " + sum2 + ", sum3 = " + sum3);
    ...
    private static void demo4() {
        ...
        // we give an operator from the operation and returns the functional interface type based on switch used
    ...
    private static void sumi5() {
        System.out.print("\nSum i^5...\nExercice calculate sumWith E n=15 of (i^5) : ");
        List<Integer> list = new ArrayList<>();
        for (int i = 1; i <= 15; i++) {
            list.add(i);
        }

        int result = sumOfWith(list, x -> (int) Math.pow(x, 5));    // Cast is necessary because we have Integers
        System.out.println(result);
    }

    // too much complicate mathematics in the others examples
