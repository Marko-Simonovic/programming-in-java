...
public interface Utils {
    ...
    // creates a List that will have one director by element
    ...
    // Creates a List that will have one actor by element (movie)
    ...
    // Creates a list that will have a duo of actor by movie
