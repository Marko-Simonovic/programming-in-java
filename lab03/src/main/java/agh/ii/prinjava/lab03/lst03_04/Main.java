...
public class Main {
     ...
     * <br><br>
     * <b>If we want to use a Ressource, we put it in the parameter, it will create/open the
     * ressource at the beginning automaticaly at the end, thus preventing from forgetting
     * or complicating things.</b>
     */
    ...
    private static void demo3() {
        ...
        try {
            ...
            if (r2 != null) { // r2 can be null, see (1)
                try {
                    r2.close(); // CLOSE CAN ALSO THROW AN EXCEPTION THAT'S WHY IT' MESSY
                } catch (ChEx2 e) {
                    System.out.println("demo3: catch (ChEx2 e)");
                }
            } else {
