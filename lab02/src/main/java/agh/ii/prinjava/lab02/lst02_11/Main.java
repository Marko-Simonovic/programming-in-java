...
/**
 * <u>Question 1 & 2:</u>
 * <br>Lambda expression is a shorter way to write anonymous class.
 * It needs a Functional Interface in order to work.
 * We use it like this : <br>
 * <b>(arguments) -> {statement/s}</b><br>
 * We dont need to write a name to our function or anything
 */
public class Main {
    private static void demoIntToInt() {
        System.out.println("Marko's test...");
        IntToInt m1 = (y) -> {
            System.out.println("Calculating...");
            return 3*y;
        };
        System.out.println("result : " + m1.apply(3));
    }
    ...
    private static void demo3() {
        ...
        // (arguments : int) -> {statements returns int}
        I3 i31 = new I3() {
            @Override
    ...
    private static void demo4() {
        ...
        I4 i41 = new I4() {
            // (arguments : int, int) -> {statements returns void}
            @Override
